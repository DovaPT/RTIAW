...
fn main() {
    ...
    world.add_sphere(Sphere::new([0.0, -100.5, -1.0], 100.0, material_ground));
    world.add_sphere(Sphere::new([0.0, 0.0, -1.2], 0.5, material_center));
    world.add_sphere(Sphere::new([-1.0, 0.0, -1.0], 0.5, material_left));
    world.add_sphere(Sphere::new([-1.0, 0.0, -1.0], 0.4, material_bubble));
    world.add_sphere(Sphere::new([1.0, 0.0, -1.0], 0.5, material_right));
