...
use renderer::{camera::{render, Camera}, color::Color, hittable_list::HittableList, sphere::Sphere};
...
fn main() {
    ...
    for a in -11..11 {
        for b in -11..11{
            ...
            let center = Point3::new(a as f64 + 0.9 * rand_f64(), 0.2, b as f64 + 0.9 * rand_f64());
